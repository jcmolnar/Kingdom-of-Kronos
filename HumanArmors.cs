$jumpSurfaceMinDot = 0.02;		//0.92 prevents skiing
$damageScale = 0.01;			//used to be 0.055
...
$ArmorForSpeed[MaleHuman, 4] = MaleHumanArmor11;	//has jetpack n speed
