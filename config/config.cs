...
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.000957);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.000957);
...
bindAction(keyboard0, make, "numpad8", TO, IDACTION_LOOKUP, 0.099984);
bindAction(keyboard0, break, "numpad8", TO, IDACTION_LOOKUP, 0.000000);
bindAction(keyboard0, make, "numpad2", TO, IDACTION_LOOKDOWN, 0.099984);
bindAction(keyboard0, break, "numpad2", TO, IDACTION_LOOKDOWN, 0.000000);
bindAction(keyboard0, make, "numpad6", TO, IDACTION_TURNRIGHT, 0.099984);
bindAction(keyboard0, break, "numpad6", TO, IDACTION_TURNRIGHT, 0.000000);
bindAction(keyboard0, make, "numpad4", TO, IDACTION_TURNLEFT, 0.099984);
