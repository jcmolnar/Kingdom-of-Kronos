...
bindAction(keyboard0, make, "left", TO, IDACTION_TURNLEFT, 0.099854);
bindAction(keyboard0, break, "left", TO, IDACTION_TURNLEFT, 0.000000);
bindAction(keyboard0, make, "right", TO, IDACTION_TURNRIGHT, 0.099854);
bindAction(keyboard0, break, "right", TO, IDACTION_TURNRIGHT, 0.000000);
bindAction(joystick0, rzaxis0, TO, IDACTION_RUN, Center, DeadZone, 0.099570, Scale, 1.000000);
bindCommand(keyboard0, make, "t", TO, "use(\"Backpack\");");
bindAction(joystick0, xaxis0, TO, IDACTION_YAW, Center, DeadZone, 0.099570, Scale, 0.099570);
bindAction(joystick0, yaxis0, TO, IDACTION_PITCH, Center, DeadZone, 0.099570, Scale, 0.099570);
...
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.003777);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.003777);
