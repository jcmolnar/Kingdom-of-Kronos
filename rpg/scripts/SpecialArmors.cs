...
PlayerData DeathKnightArmor22
{
   ...
   boxNormalHeadPercentage  = 0.50; 
   boxNormalTorsoPercentage = 0.50; 

   boxHeadLeftPercentage  = 0.50; 
   boxHeadRightPercentage = 0.50; 
   boxHeadBackPercentage  = 0.50; 
   boxHeadFrontPercentage = 0.50;
};

//------------------------------------------------------------------
// AdminBootsArmor data (custom armor for AdminBoots with reduced speed):
//------------------------------------------------------------------

PlayerData AdminBootsArmor
{
   className = "Armor";
   shapeFile = "larmor";
   flameShapeName = "lflame";
