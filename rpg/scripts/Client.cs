...
{
	%time = getSimTime();
	if(%time > %cl.animtime + 20 || %cl.animtime == "")
	{
		%cl.animtime = %time;
...
{
   if(%pctDone < 0.1)
      %text = "Beginning set up...";
   else if(%pctDone < 0.2)
      %text = "Cleaning Swords...";
   else if(%pctDone < 0.3)
      %text = "Applying armor...";
   else if(%pctDone < 0.4)
      %text = "Charging Mana...";
   else if(%pctDone < 0.5)
      %text = "Checking House Status...";
   else if(%pctDone < 0.6)
      %text = "Gathering Character Info...";
   else if(%pctDone < 0.7)
      %text = "Knocking on Doors at Yuliple...";
   else if(%pctDone < 0.8)
...
function dataFinished()
{
   ...
   Control::setValue(ProgressText, "<jc><f0>Welcome to the Kingdom");
   Control::setValue(ProgressSlider, 1.0);
