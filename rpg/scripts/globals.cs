...
$invalidChars = " ><?\\\"{}[]+=:;/.,~!@#$%^&*()|`_-";
$maxDamagedBy = 10;
// CRITICAL: Increased from 60 to 300 seconds (5 minutes) to handle long fights
// When damage is added to existing entries, the timer is rescheduled, extending it
// This ensures damage tracking persists even for extended battles
$damagedByEraseDelay = 300;
