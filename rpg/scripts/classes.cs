...
$MinHP[God] = 4000;
$MinHP[Seals] = 3000;  // Base HP for seal battle bots
...
function getFinalCLASS(%clientId)
{
	...
	// If CLASS is empty or not set, check if this is a bot and return appropriate default
	if(%class == "" || %class == -1 || %class == "0")
	{
		// Check if this is a bot (town bot or enemy bot)
		...
		{
			// This is a bot - return "NPC" instead of "Joining"
			return "NPC";
		}
		else if(%spawnBotInfo != "" && %spawnBotInfo != "0" && %spawnBotInfo != -1)
		{
			// This is an enemy bot - return "NPC" instead of "Joining"
			return "NPC";
		}
		// Not a bot - return "Joining" for players without a class
		return Joining;
	}

	for(%i = 1; $ClassName[%i, 0] != ""; %i++)
	{
		if(String::ICompare($ClassName[%i, 0], %class) == 0)
...
$WorldRank[8] = "God";
$WorldRank[9] = "Immortal";
$WorldRank[10] = "Transcendent";
...
$TournyRoundOne[9] = "EndGame";
$TournyRoundTwo[9] = "Oni";
$TournyRoundThree[9] = "Crest";
$TournyRoundOne[10] = "EndGame";
$TournyRoundTwo[10] = "Oni";
$TournyRoundThree[10] = "Crest";

// Colloseum-specific bot arrays (TournyRank name + Round word number)
$ColloseumRoundOne[0] = "NewbieRoundOne";
$ColloseumRoundTwo[0] = "NewbieRoundTwo";
$ColloseumRoundThree[0] = "NewbieRoundThree";
$ColloseumRoundOne[1] = "AdventurerRoundOne";
$ColloseumRoundTwo[1] = "AdventurerRoundTwo";
$ColloseumRoundThree[1] = "AdventurerRoundThree";
$ColloseumRoundOne[2] = "SoldierRoundOne";
$ColloseumRoundTwo[2] = "SoldierRoundTwo";
$ColloseumRoundThree[2] = "SoldierRoundThree";
$ColloseumRoundOne[3] = "GladiatorRoundOne";
$ColloseumRoundTwo[3] = "GladiatorRoundTwo";
$ColloseumRoundThree[3] = "GladiatorRoundThree";
$ColloseumRoundOne[4] = "StarRoundOne";
$ColloseumRoundTwo[4] = "StarRoundTwo";
$ColloseumRoundThree[4] = "StarRoundThree";
$ColloseumRoundOne[5] = "SuperStarRoundOne";
$ColloseumRoundTwo[5] = "SuperStarRoundTwo";
$ColloseumRoundThree[5] = "SuperStarRoundThree";
$ColloseumRoundOne[6] = "TitanRoundOne";
$ColloseumRoundTwo[6] = "TitanRoundTwo";
$ColloseumRoundThree[6] = "TitanRoundThree";
$ColloseumRoundOne[7] = "DemiGodRoundOne";
$ColloseumRoundTwo[7] = "DemiGodRoundTwo";
$ColloseumRoundThree[7] = "DemiGodRoundThree";
$ColloseumRoundOne[8] = "GodRoundOne";
$ColloseumRoundTwo[8] = "GodRoundTwo";
$ColloseumRoundThree[8] = "GodRoundThree";
$ColloseumRoundOne[9] = "ImmortalRoundOne";
$ColloseumRoundTwo[9] = "ImmortalRoundTwo";
$ColloseumRoundThree[9] = "ImmortalRoundThree";
$ColloseumRoundOne[10] = "TranscendentRoundOne";
