...
function Help::commandsMainMenu(%clientId)
{
	...
	Client::addMenuItem(%clientId, "1Armor", "1");
	Client::addMenuItem(%clientId, "2Weapons", "2");
	Client::addMenuItem(%clientId, "3Spells", "3");
	Client::addMenuItem(%clientId, "4Zones", "4");
	Client::addMenuItem(%clientId, "5Accessories", "5");
	Client::addMenuItem(%clientId, "xBack", "back");
	return;
}
...
function processMenuhelpCommandsMain(%clientId, %opt)
{
	...
	if(%o == "1")
		...
		Help::accessoriesSubMenu(%clientId);
	else if(%o == "back")
		MenuOptions(%clientId); // Return to main tab menu instead of deprecated Help::mainMenu

	return;
}

// Armor Sub Menu
function Help::armorSubMenu(%clientId)
{
	Client::buildMenu(%clientId, ".:(Armor Types):.", "helpArmorSubMenu", true);
	%clientId.bulkNum = "";
	
	Client::addMenuItem(%clientId, "1Chest Armor", "1");
	Client::addMenuItem(%clientId, "2Helmets", "2");
	Client::addMenuItem(%clientId, "3Shields", "3");
	Client::addMenuItem(%clientId, "xBack", "back");
	return;
}

function processMenuhelpArmorSubMenu(%clientId, %opt)
{
	%o = GetWord(%opt, 0);

	if(%o == "1")
		Help::showChestArmor(%clientId);
	else if(%o == "2")
		Help::showHelmets(%clientId);
	else if(%o == "3")
		Help::showShields(%clientId);
	else if(%o == "back")
		Help::commandsMainMenu(%clientId);
...
// Chest Armor Display
function Help::showChestArmor(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "CHEST ARMOR LIST");
...
// Helmets Display
function Help::showHelmets(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "HELMET LIST");
	Client::sendMessage(%clientId, $MsgWhite, "IronHelmet, GoldenHelmet, CrystalHelmet, DiamondHelmet, BlackDiamondHelmet, RedDiamondHelmet, WhiteDiamondHelmet");
	Help::armorSubMenu(%clientId);
}

// Shields Display
function Help::showShields(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "SHIELD LIST");
	Client::sendMessage(%clientId, $MsgWhite, "SteelKnightShield, CrystalKnightShield, DiamondKnightShield, BlackDiamondKnightShield");
	Client::sendMessage(%clientId, $MsgWhite, "RedDiamondKingShield, WhiteDiamondKingShield");
	Help::armorSubMenu(%clientId);
}
...
function Help::weaponsSubMenu(%clientId)
{
	...
	Client::addMenuItem(%clientId, "1Slashing", "1");
	Client::addMenuItem(%clientId, "2Piercing", "2");
	Client::addMenuItem(%clientId, "3Bludgeon", "3");
	Client::addMenuItem(%clientId, "xBack", "back");
	return;
}
...
function Help::spellsSubMenu(%clientId)
{
	...
	Client::addMenuItem(%clientId, "1Offensive Spells", "1");
	Client::addMenuItem(%clientId, "2Defensive Spells", "2");
	Client::addMenuItem(%clientId, "3Neutral Spells", "3");
	Client::addMenuItem(%clientId, "xBack", "back");
	return;
}
...
function Help::accessoriesSubMenu(%clientId)
{
	Client::buildMenu(%clientId, ".:(Accessory Types):.", "helpAccessoriesSubMenu", true);
	%clientId.bulkNum = "";
	
	Client::addMenuItem(%clientId, "1Rings", "1");
	Client::addMenuItem(%clientId, "2Belts", "2");
	Client::addMenuItem(%clientId, "3Necklaces", "3");
	Client::addMenuItem(%clientId, "xBack", "back");
	return;
}

function processMenuhelpAccessoriesSubMenu(%clientId, %opt)
{
	%o = GetWord(%opt, 0);

	if(%o == "1")
		Help::showRings(%clientId);
	else if(%o == "2")
		Help::showBelts(%clientId);
	else if(%o == "3")
		Help::showNecklaces(%clientId);
	else if(%o == "back")
		Help::commandsMainMenu(%clientId);
...
// Rings Display
function Help::showRings(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "RING LIST");
	Client::sendMessage(%clientId, $MsgWhite, "MinorPowerRing, PowerRing, MajorPowerRing, ExtremePowerRing, GodlyPowerRing, HeavenlyPowerRing");
	Help::accessoriesSubMenu(%clientId);
}

// Belts Display
function Help::showBelts(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "BELT LIST");
	Client::sendMessage(%clientId, $MsgWhite, "AntiMagicBelt, MajorAntiMagicBelt, ExtremeAntiMagicBelt, GodlyAntiMagicBelt, HeavenlyAntiMagicBelt");
	Help::accessoriesSubMenu(%clientId);
}

// Necklaces Display
function Help::showNecklaces(%clientId)
{
	Client::sendMessage(%clientId, $MsgRed, "NECKLACE LIST");
	Client::sendMessage(%clientId, $MsgWhite, "MinorRegenerationNecklace, RegenerationNecklace, MajorRegenerationNecklace");
	Client::sendMessage(%clientId, $MsgWhite, "ExtremeRegenerationNecklace, GodlyRegenerationNecklace, HeavenlyRegenerationNecklace");
	Help::accessoriesSubMenu(%clientId);
}
...
function Help::showZones(%clientId)
{
	...
	Client::sendMessage(%clientId, $MsgGreen, "Yuliple City - Empress Sanctuary - Curama Outpost - Arbal Research Center - Black Market - Kingdom of Kronos - Asna's Pad - Lamisor - Porellis - Gian Echoes");
	...
	for(%i = 1; %i <= $numZones; %i++)
	{
		...
		if(%zoneName != "" && %zoneType == "FREEFORALL")
			{
				if(%freeforallMsg != "")
