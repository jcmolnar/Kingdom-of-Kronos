...
//GNOLL SOUNDS
SoundData SoundPigmanDeath1
{
	wavFileName = "GnollDeath1.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanDeath2
{
	wavFileName = "GnollDeath2.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanAcquired1
{
	wavFileName = "GnollAcquired1.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanTaunt1
{
	wavFileName = "GnollTaunt1.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanRandom1
{
	wavFileName = "GnollRandom1.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanRandom2
{
	wavFileName = "GnollRandom2.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanHit1
{
	wavFileName = "GnollHit1.wav";
	profile = Profile3dNear;
};
SoundData SoundPigmanHit2
{
...
function RandomRaceSound(%race, %type)
{
	...
	// Check if the sound exists before accessing
	if($RaceSound[%race, %type, %r] != "")
