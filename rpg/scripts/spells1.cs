...
$Spell::keyword[37] = "NoobCloud";
$Spell::index[NoobCloud] = 37;
$Spell::name[37] = "Noobish Cloud Attack";
$Spell::description[37] = "Casts an noob explosive.";
$Spell::delay[37] = 0.5;
$Spell::recoveryTime[37] = 0.625;
$Spell::radius[37] = 10;
$Spell::damageValue[37] = "15";
$Spell::LOSrange[37] = 80;
$Spell::manaCost[37] = 5;
$Spell::startSound[37] = ActivateBF;
$Spell::endSound[37] = ExplodeLM;
$Spell::groupListCheck[37] = False;
$Spell::refVal[37] = 15;
$Spell::graceDistance[37] = 2;
$SkillType[noobcloud] = $SkillOffensiveCasting;

$Spell::keyword[38] = "FreezerBurn";
$Spell::index[FreezerBurn] = 38;
$Spell::name[38] = "FreezerBurn";
$Spell::description[38] = "Something NASTY comin' out of your freezer.";
$Spell::delay[38] = 0.00005;
$Spell::recoveryTime[38] = 0.055;
$Spell::radius[38] = 20;
$Spell::damageValue[38] = "105";
$Spell::LOSrange[38] = 80;
$Spell::manaCost[38] = 25;
$Spell::startSound[38] = ImpactTR;
$Spell::endSound[38] = Reflected;
$Spell::groupListCheck[38] = False;
$Spell::refVal[38] = 105;
$Spell::graceDistance[38] = 2;
$SkillType[FreezerBurn] = $SkillOffensiveCasting;

$Spell::keyword[39] = "Apocalypse";
$Spell::index[Apocalypse] = 39;
$Spell::name[39] = "Apocalypse";
$Spell::description[39] = "Casts Apocalypse.";
$Spell::delay[39] = 7.5;
$Spell::recoveryTime[39] = 40.25;
$Spell::radius[39] = 300;
$Spell::damageValue[39] = "1500";
$Spell::LOSrange[39] = 80;
$Spell::manaCost[39] = 90;
$Spell::startSound[39] = LaunchLS;
$Spell::endSound[39] = Explode3FW;
$Spell::groupListCheck[39] = False;
$Spell::refVal[39] = 1500;
$Spell::graceDistance[39] = 2;
$SkillType[Apocalypse] = $SkillOffensiveCasting;

$Spell::keyword[40] = "Nuke";
$Spell::index[Nuke] = 40;
$Spell::name[40] = "Nuke";
$Spell::description[40] = "A Nuclear Explosion";
$Spell::delay[40] = 6;
$Spell::recoveryTime[40] = 15.5;
$Spell::radius[40] = 150;
$Spell::damageValue[40] = "600";
$Spell::LOSrange[40] = 80;
$Spell::manaCost[40] = 50;
$Spell::startSound[40] = LoopLS;
$Spell::endSound[40] = LaunchET;
$Spell::groupListCheck[40] = False;
$Spell::refVal[40] = 600;
$Spell::graceDistance[40] = 2;
$SkillType[Nuke] = $SkillOffensiveCasting;

$Spell::keyword[41] = "Tornado";
$Spell::index[Tornado] = 41;
$Spell::name[41] = "Tornado";
$Spell::description[41] = "Call a Tornado to your aid.";
$Spell::delay[41] = 5;
$Spell::recoveryTime[41] = 20;
$Spell::radius[41] = 10;
$Spell::damageValue[41] = "130";
$Spell::LOSrange[41] = 80;
$Spell::manaCost[41] = 75;
$Spell::startSound[41] = LaunchLS;
$Spell::endSound[41] = Explode3FW;
		...
		if(String::ICompare($Spell::keyword[%i], %w1) == 0)
		{
			if(SkillCanUse(%clientId, $Spell::keyword[%i]))
			{
				if(fetchData(%clientId, "MANA") >= $Spell::manaCost[%i])
				{
					...
					schedule("%retval=DoCastSpell(" @ %clientId @ ", " @ %i @ ", \"" @ GameBase::getPosition(%clientId) @ "\", \"" @ %lospos @ "\", \"" @ %losobj @ "\", \"" @ %w2 @ "\", \"" @ %casterName @ "\"); if(%retval){refreshMANA(" @ %clientId @ ", " @ %tempManaCost @ ");}", $Spell::delay[%i]);
...
function DoCastSpell(%clientId, %index, %oldpos, %castPos, %castObj, %w2, %expectedCasterName)
{
	...
	function getNeededLeveltoRemort(%id)
	{
	return (101 + fetchdata(%id, "Remort Step"));
	}
	if(%index == 22)
	{
...
//					}
	...
	if(%index == 37)
	{
		//noobcloud spell, casts to LOS with radius damage
	...
	if(%index == 41)
	{
				if(%castPos != "")
		{
			Dopart1(%castpos, %clientid, %player, %index);
